    ...
    cases := [...]testcase{
        {
            ...
            want: nfa.NewMachine([]State{0}, []State{1, 3, 4}, []Transition{
                {From: 0, To: 4, By: "a"},
                {From: 2, To: 3, By: "a"},
                {From: 4, To: 3, By: "a"},
            }),
        ...
        {
            name: "just works 2",
            got: nfa.NewMachine([]State{0}, []State{4}, []Transition{
                {From: 0, To: 1, By: "a"},
                {From: 1, To: 2, By: "a"},
                {From: 1, To: 3, By: "a"},
                {From: 2, To: 4, By: "a"},
            ...
            want: nfa.NewMachine([]State{0}, []State{4}, []Transition{
                {From: 0, To: 1, By: "a"},
                {From: 1, To: 5, By: "a"},
                {From: 5, To: 4, By: "a"},
                {From: 2, To: 4, By: "a"},
        ...
        {
            name: "two starts",
            got: nfa.NewMachine([]State{0, 1}, []State{2}, []Transition{
                {From: 0, To: 2, By: "a"},
                {From: 1, To: 2, By: "a"},
            }),
            want: nfa.NewMachine([]State{3}, []State{2}, []Transition{
                {From: 0, To: 2, By: "a"},
                {From: 1, To: 2, By: "a"},
                {From: 3, To: 2, By: "a"},
            }),
        },
        {
            ...
            got: nfa.NewMachine([]State{0}, []State{3}, []Transition{
                {From: 0, To: 1, By: "a"},
                {From: 1, To: 2, By: "a"},
                {From: 2, To: 3, By: "a"},
            }),
            want: nfa.NewMachine([]State{0}, []State{3}, []Transition{
                {From: 0, To: 1, By: "a"},
                {From: 1, To: 2, By: "a"},
                {From: 2, To: 3, By: "a"},
            }),
